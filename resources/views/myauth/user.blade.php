...
@section('content')
    ...
    <head>
        ...
        <script src="{{URL::asset('myauth/controllers/ChatController.js')}}"></script>
    ...
    <div class="list-group col-md-2" id="navbar" style="">
        ...
        <a href="#mychat" class="list-group-item list-group-item-action mycss"><span style="color: brown;">Message</span> </a>
        {{--<a href="#registr" class="list-group-item list-group-item-action mycss"><span style="color: brown;">Registr</span> </a>--}}

    </div>
    <div class="col-md-10 ng_view"></div>
